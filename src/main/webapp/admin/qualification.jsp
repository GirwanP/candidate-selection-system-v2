...
<spr:admin header1="List Associate">
 ...
 <div class="container-main">
		...
		<button type="button" class="btn btn-primary  pull-right float-right" data-toggle="modal"
			data-target=".bd-example-modal-lg">Register New Qualification</button>
		...
		<div class="modal fade bd-example-modal-lg" tabindex="-1"
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<label class="text-dark font-weight-bold">Register new Qualification  </label> 
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label for="inputPassword4">Field </label> <input
									type="text" class="form-control" id="fieldOfStudy" name="fieldOfStudy">
							</div>
						</div>
						...
						<div class="form-row">
							<div class="form-group col-md-8">
								<label >Qualification Type</label> 
									...
									<select class="form-control" id="type" placeholder="fsdf" name="typeid">
						...
						<label for="inputCity">Duration</label>
							<div class="form-group col-md-3">
								<label for="inputCity">Years</label> <input type="number"
									class="form-control" id="years" name="years">
							</div><div class="form-group col-md-3">
								<label for="inputCity">Month</label> <input type="number"
									class="form-control" id="months" name="months">
							</div><div class="form-group col-md-3">
					...
					<tbody>
						...
						<c:forEach items="${qlist }" var="q">
							<tr>
								...
								<td>${q.length}</td>
								<td> 
									<a href="removequalification?qid=${q.id}">Invalidate Qualification</a>
								</td>
